...
<div class="heading">
   <h3>Paiement</h3>
   <p><a href="index.php">accueil</a> <span> / Paiement</span></p>
</div>

<section class="checkout">

   <h1 class="title">Résumé de la commande</h1>
...
<form action="" method="post">
   ...
   <div class="cart-items">
      ...
      <a href="cart.php" class="btn">voir panier</a>
   </div>
   ...
   <div class="user-info">
      ...
      <a href="update_profile.php" class="btn">modifier l'info</a>
      <h3> address</h3>
      <p><i class="fas fa-map-marker-alt"></i><span><?php if($fetch_profile['address'] == ''){echo "s'il vous-plait entrer ton addresse email";}else{echo $fetch_profile['address'];} ?></span></p>
      <a href="update_address.php" class="btn">mette a jour l'address</a>
